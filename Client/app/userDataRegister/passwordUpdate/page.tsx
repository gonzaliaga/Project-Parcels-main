    ...
    <form onSubmit={handleSubmit}>
      <div className="mt-[1rem]">
        ...
        <div className="bg-white mt-4 w-[60%] mb-6 shadow-xl rounded-lg p-4 space-y-8 ">
              ...
              <input
                ...
                className={
                  error
                    ...
                    : "peer h-full w-full rounded-[7px] border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-4 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-[#00ad68be] focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                }
                placeholder=" "
          ...
          <button
            className="w-full bg-[#039D60] py-3 text-white rounded-md"
